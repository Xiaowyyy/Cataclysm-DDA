                                ...
                                std::optional<std::reference_wrapper<const aim_mods_cache>> aim_cache ) const
{
    ...
    aim_speed /= std::max( 1.0, 2.0 - 0.25 * get_skill_level( gun_skill ) );
    ...
    double base_aim_speed_cap = 5.0 +  2.0 * get_skill_level( gun_skill ) + std::max( 10.0,
                                2.0 * get_skill_level( gun_skill ) );
    if( !use_cache ) {
